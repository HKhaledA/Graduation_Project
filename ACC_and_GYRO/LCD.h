...
#define LCD_Control_reg_DIR DDRC
#define LCD_Control_reg_OP  PORTC
#define LCD_Control_reg_IP	PINC

#define LCD_Data_Reg_DIR DDRB
#define LCD_Data_Reg_OP	PORTB
#define LCD_Data_Reg_IP	PINB
