...
#define LCD_Control_reg_DIR DDRB
#define LCD_Control_reg_OP  PORTB
#define LCD_Control_reg_IP	PINB

#define LCD_Data_Reg_DIR DDRD
#define LCD_Data_Reg_OP	PORTD
#define LCD_Data_Reg_IP	PIND
